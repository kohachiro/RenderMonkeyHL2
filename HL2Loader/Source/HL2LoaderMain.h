...
#ifndef _HL2Loader_Main_H_
#define _HL2Loader_Main_H_
...
class CHL2LoaderKernel
{
public :
   CHL2LoaderKernel();
   virtual ~CHL2LoaderKernel();
...
private :
   ...
   // by the same kernel. 
   CHL2LoaderPlugIn *m_pLoaderPlugIn;       

}; // End of CHL2LoaderKernel class declaration
