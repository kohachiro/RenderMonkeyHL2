...
struct vertexFileHeader_t
{
	...
	//FIXME:dahoo  add by get the Vertex
	inline mstudiovertex_t *pVertex( int i ) const 
	{ 
		return (mstudiovertex_t *)(((byte *)this) + vertexDataStart) + i; 
	};
	inline Vector4D *pTangent( int i ) const 
	{ 
		return (Vector4D *)(((byte *)this) + tangentDataStart) + i; 
	};
};
